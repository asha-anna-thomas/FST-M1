...
with webdriver.Chrome() as driver:
    ...
    wait.until(expected_conditions.element_to_be_clickable((By.XPATH, "//button[text()='Open A New Tab']"))).click()
    ...
    wait.until(expected_conditions.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Another One')]")))
